<template>
  <section class="demo-section">
    ...
    <div class="demo-actions">
      ...
      ><button class="demo-control" @click="run('列表校验', () => form?.submit())" :disabled="viewOnly">校验</button>
    </div>
    <SuperDetail v-if="viewOnly" :key="pageKey" :schema="detailSchema" :data-source="model" />
    ...
    <Teleport to="#demo-test-content"
      ><div class="dev-tools">
        <h2 class="demo-test-title">开发与测试 · 列表增删与插入锚点</h2>
...
const { run, status } = useDemo(() => ({ model }))
