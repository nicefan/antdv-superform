...
export declare const elementPlusCapabilities: Pick<UIAdapter, 'components' | 'form' | 'layout' | 'containers' | 'icons' | 'actions' | 'presentation' | 'services' | 'modal' | 'upload' | 'preview' | 'table'>;
...
declare const product: OfficialSuperFormProduct<ElementPlusFieldName>;
