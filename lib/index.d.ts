...
export declare function createModal(
  content: (() => VNodeTypes) | VNode,
  { buttons, ...__config }?: Obj
): {
  modalRef: Ref_2<any>
  modalSlot: (
    props: any,
...
export declare type ExtButtons<T extends string = string> =
  | ExtButtonGroup<T>
  | NonNullable<ExtButtonGroup<T>['actions']>
...
export declare function useButtons(config: ExtButtonGroup): (() => VNode<
  RendererNode,
  RendererElement,
  {
    [key: string]: any
...
export declare function useForm(
  option: UseFormOption,
  data?: Obj
): readonly [
  (actions?: Obj, ref?: Obj) => any,
  {
...
export declare function useModalForm(
