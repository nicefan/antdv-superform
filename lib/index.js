...
import { defaults, merge, cloneDeep, isPlainObject, isArray, uniq, throttle, debounce, mapKeys, camelCase } from "lodash-es";
import { h, inject, reactive, ref, unref, watchEffect, toValue, toRef, computed, watch, onMounted, toRefs, mergeProps, markRaw, defineComponent, openBlock, createBlock, withModifiers, withCtx, createElementBlock, Fragment, renderList, createVNode, normalizeProps, guardReactiveProps, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, provide, toRaw, readonly, useAttrs, shallowReactive, onUnmounted, getCurrentInstance, nextTick, render as render$1, createSlots, normalizeClass, watchPostEffect, shallowRef, useSlots } from "vue";
...
function getViewNode(option, effectData = {}) {
  ...
  if (colRender) {
    return (param = effectData) => {
      const vModels = getVModelProps(option, param.current);
      const props = reactive({ props: { ...option.attrs, ...vModels }, ...param });
      if (content) {
...
function createButtons({ config, methods, params, isView }) {
  ...
  if (actions.length === 0)
    return;
  return (props = {}) => h(_sfc_main$s, { config: buttons, methods, param: params, ...props });
}
...
function buildInnerNode(option, model, effectData, attrs) {
  ...
  if (type === "Text" || type === "InfoSlot") {
    ...
    node = () => h(_sfc_main$s, { config: option, param: effectData });
      ...
      const rows = () => layout === "vertical" ? rowGroup.flatMap((group) => [
        ...
        rowGroup.map(
          (group, idx) => h(
            ...
            { class: "ant-descriptions-row" },
            group.flatMap(
              (item) => !unref(item.hidden) && (!item.label ? [h("td", { colspan: item.colspan * 2 }, item.content())] : [
                h(
                  "th",
                  mergeProps(
                    { class: "ant-descriptions-item-label" },
        ...
        () => rowGroup.flat().map(({ option, content, span, label, labelCol, wrapperCol, hidden, attrs }) => {
          ...
          return h(
            ...
            () => h(Row, { class: ["ant-descriptions-item-container"] }, () => [
              label && h(Col, mergeProps({ class: "ant-descriptions-item-label" }, labelCol), () => h("label", {}, label())),
              h(
                Col,
      ...
      if (type === "InputGroup") {
        if (!viewRender) {
          ...
          const contents = [...modelsMap2].map(([opt, model2]) => {
            ...
            const showLabel = ((_a2 = option.attrs) == null ? void 0 : _a2.compact) === false && labelSlot2;
...
const _sfc_main$q = defineComponent({
  ...
  setup({ option, model, effectData, isView }, ctx) {
    ...
    const slots = {
      ...
      actions: buttonsSlot,
      default: ctx.slots.innerContent || (isView ? () => h(DetailLayouts, { option: { descriptionsProps: option.attrs, ...option }, modelsMap: model.children }) : () => h(Collections, { option, model, effectData }))
    };
...
const Form = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__cssModules", cssModules]]);
...
const _sfc_main$n = defineComponent({
  ...
  setup(props, ctx) {
    ...
    if (isView) {
      if (isFormItem) {
        if (isSingle) {
          const { isBreak, label: label2, labelSlot: labelSlot2 = label2 } = columns[0];
          return () => h(
            Space,
          ...
          return () => listItems.value.map(({ children: children2, effectData: effectData2 }) => {
            const [_option2, model2] = [...children2][0];
            const option2 = _option2.descriptionsProps ? _option2 : { ..._option2, descriptionsProps: { mode: "default", labelCol: {} } };
            return h(DetailLayouts, { modelsMap: model2.children, option: option2, effectData: effectData2 });
          });
        }
      }
      const attrs = {};
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup({
    ...
    return () => h(base.Card, {}, {
      ...
      extra: () => buttons && !isView && h(_sfc_main$s, {
        config: buttons,
        param: effectData
      }),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Tabs2), {
        ...
        rightExtra: withCtx(() => [!_ctx.isView && _ctx.option.buttons ? (openBlock(), createBlock(unref(_sfc_main$s), {
          key: 0,
...
function createModal(content, { buttons, ...__config } = {}) {
  ...
  const modalRef = ref();
  const footer = buttons && (() => h(_sfc_main$s, { config: buttons, param: { modalRef } }));
...
function inlineRender({
  ...
  const editButtonsSlot = (param, config) => {
    ...
    return editInfo.isEdit ? h(_sfc_main$s, {
      key: "edit",
      config: {
        ...config,
        actions: editActions
...
function buildDetail(option, modelsMap, rowKey) {
  const source = ref({});
  const detail = () => h(_sfc_main$r, { option, modelsMap, source });
...
const _sfc_main$h = defineComponent({
  ...
  setup({ option, model, apis = {}, effectData, isView }, ctx) {
    ...
    if (titleSlot || extraSlot) {
      __slots.title = () => h(Row, { align: "middle", style: "width:100%" }, () => [
              ...
              return openBlock(), createElementBlock(Fragment, { key }, [
                !hidden.value ? (openBlock(), createBlock(unref(CollapsePanel2), mergeProps({
                  ...
                  !_ctx.isView ? {
                    name: "extra",
                    fn: withCtx(() => [
                      option.buttons ? (openBlock(), createBlock(unref(_sfc_main$s), {
                        key: 0,
...
const components = {
  ...
  Card: _sfc_main$m,
  List: _sfc_main$l,
  ListGroup: _sfc_main$k,
  Tabs: _sfc_main$j,
  Table: _sfc_main$h,
  Collapse: _sfc_main$f,
  Descriptions: _sfc_main$q
};
const formItems = {
  Textarea: _sfc_main$g,
  Input: _sfc_main$e,
  InputNumber: _sfc_main$d,
  InputGroup: _sfc_main$o,
  InputList: _sfc_main$n,
  Select: _sfc_main$c,
  Switch: _sfc_main$b,
...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => h(_sfc_main$s, { config: { ...props, actions } });
  }
});
function useButtons(config) {
  const vNode = () => h(_sfc_main$s, { config });
  return [vNode];
}
