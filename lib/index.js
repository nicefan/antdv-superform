...
function useForm(option, data) {
  ...
  const register = (actions) => {
    if (actions) {
      ...
      return (props, ctx) => h(_sfc_main$3, { config: option, model: model.value, ...props, onRegister: register }, ctx == null ? void 0 : ctx.slots);
    }
  };
  ...
  return [
    register,
    {
      ...
      getSource: () => {
        const source = ref();
        asyncCall("dataSource").then((data2) => source.value = data2);
        return source;
      },
...
const useTable = (option, data) => {
  ...
  const register = (actions) => {
    if (actions) {
      ...
      return (props, ctx) => h(_sfc_main$2, { dataSource: data, option, ...props, onRegister: register }, ctx == null ? void 0 : ctx.slots);
    }
  };
