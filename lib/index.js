...
import { get, set, merge as merge$1, update, cloneDeep, isPlainObject, defaults, isArray, uniq, isFunction, isString, isObject, throttle, mergeWith, debounce, mapKeys, camelCase } from "lodash-es";
...
function editModal({ rowKey, option, listener }) {
  ...
  const methods = {
    ...
    async edit(args) {
      ...
      merge$1(source.value, resetData);
