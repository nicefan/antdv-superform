import { inject, readonly, toRefs, shallowReactive, ref, unref, watchEffect, reactive, toRef, watch, onMounted, computed, defineComponent, createVNode, h, openBlock, createElementBlock, normalizeProps, guardReactiveProps, createBlock, withCtx, renderSlot, createTextVNode, toDisplayString, createCommentVNode, resolveComponent, withModifiers, Fragment, renderList, mergeProps, createElementVNode, KeepAlive, getCurrentInstance, render as render$1, toRaw, watchPostEffect, isRef, provide, isVNode } from "vue";
...
function buildModelDeep(children, { parent, propChain = [], rules = {}, refName = "" }) {
  ...
  cols.forEach((child) => {
    ...
    const subModel = field ? buildModel$1(child, currentModel) : currentModel;
    const item = {
      model: subModel
    };
    if (subItems) {
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", normalizeProps(guardReactiveProps(__props.attrs)), [
        __props.option.title ? (openBlock(), createBlock(unref(Row2), {
          key: 0,
          span: 24,
          class: "title"
        }, {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "title", {}, () => [
              createVNode(unref(Divider2), { orientation: "left" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(__props.option.title), 1)
                ]),
                _: 1
              })
            ])
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(FormItem2), { style: { "margin": "0" } }, {
        default: withCtx(() => [
          createVNode(unref(InputGroup2), normalizeProps(guardReactiveProps(__props.attrs)), {
            default: withCtx(() => [
              createVNode(unref(Collections), normalizeProps(guardReactiveProps(props)), null, 16)
            ]),
            _: 1
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Card2), mergeProps({ title: unref(title) }, __props.attrs), {
        extra: withCtx(() => [
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(List2), mergeProps({ "data-source": listItems.value }, __props.attrs), {
        header: withCtx(() => [
      ...
      return openBlock(), createBlock(unref(FormItem2), null, {
        default: withCtx(() => [
          createVNode(unref(Input2), mergeProps({
            readonly: !!__props.option.keepField,
            placeholder: "请输入" + (__props.option.label || ""),
            "max-length": "100",
            ...
            addonAfter: withCtx(() => [
              __props.option.btnClick ? (openBlock(), createBlock(unref(Button2), {
                key: 0,
                disabled: __props.attrs.disabled,
                class: "ant-input-search-button",
                onClick: _cache[0] || (_cache[0] = ($event) => {
                  var _a, _b;
                  return (_b = (_a = __props.option).btnClick) == null ? void 0 : _b.call(_a, __props.effectData, $event);
                })
              }, {
                default: withCtx(() => [
      ...
      return openBlock(), createBlock(unref(FormItem2), null, {
        default: withCtx(() => [
          createVNode(unref(Switch2), mergeProps({
            ...
            "checked-value": 1,
            "un-checked-value": 0
          }, __props.attrs), null, 16, ["checked", "checked-children", "un-checked-children"])
        ]),
        _: 1
      });
    };
      ...
      return openBlock(), createBlock(unref(FormItem2), null, {
        default: withCtx(() => [
          createVNode(unref(RadioGroup2), mergeProps({
            name: __props.option.field
          }, allAttrs), {
            default: withCtx(() => [
              __props.attrs.buttonStyle ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(options.value, ({ label, value, disabled }) => {
