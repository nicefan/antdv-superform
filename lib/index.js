...
import { Modal, Space, Tooltip, Button, Dropdown, Menu, MenuItem, Card, Checkbox, CheckboxGroup, Col, Collapse, CollapsePanel, DatePicker, Descriptions as Descriptions$1, DescriptionsItem, Form as Form$1, FormItem as FormItem$1, Input, InputGroup, InputNumber, InputSearch, List, ListItem, Radio, RadioButton, RadioGroup as RadioGroup$1, RangePicker, Row, Select, Switch, TabPane, Table, Tabs, Textarea, TimePicker, TreeSelect, Divider } from "ant-design-vue";
      ...
      config.onClick = (param) => {
        if (_onClick && innerMethod) {
          _onClick(param, (confirmText = config.confirmText) => {
            _action(confirmText, () => innerMethod == null ? void 0 : innerMethod({ ...param, meta }));
          });
        } else {
...
const _sfc_main$h = defineComponent({
  ...
  setup({ option, model, apis = {}, effectData, isView }, ctx) {
    ...
    const exposed = reactive({
      ...
      detail: (meta) => {
        var _a2;
        return (_a2 = methods.detail) == null ? void 0 : _a2.call(methods, { ...editParam, meta });
      }
    });
    return () => [
...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const actions = !slotsNode ? props.actions : slotsNode.flatMap(({ children, props: props2 }) => {
      const { roleName, roleMode, onClick, confirmText, tooltip, icon, ...attrs } = props2 || {};
      if (!onClick || !children)
        return [];
      return {
