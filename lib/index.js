...
import { defineComponent, h, toRaw, inject, reactive, ref, isRef, watchEffect, computed, toValue, toRef, watch, unref, toRefs, mergeProps, markRaw, openBlock, createBlock, withModifiers, withCtx, createElementBlock, Fragment, renderList, createVNode, createSlots, resolveDynamicComponent, createCommentVNode, normalizeProps, guardReactiveProps, provide, readonly, shallowRef, useAttrs, onMounted, shallowReactive, getCurrentInstance, onUnmounted, nextTick, render as render$1, watchPostEffect, renderSlot, createTextVNode, toDisplayString, Teleport, useSlots } from "vue";
import { useConfig } from "antdv-next/config-provider/context";
import { SpaceCompact, Form, FormItem, Tooltip, Button, Space, Card, Descriptions as Descriptions$1, DescriptionsItem, Modal, Table, Tabs, TabPane, CollapsePanel, Collapse, Input, InputNumber, InputSearch, TextArea, Select, Switch, DateRangePicker, TimeRangePicker, DatePicker, TimePicker, RadioButton, Radio, RadioGroup, Checkbox, CheckboxGroup, TreeSelect, Row, Col, Upload, Tag, CheckableTag, AutoComplete, Dropdown, Menu, MenuItem, Divider, message, ConfigProvider, Image } from "antdv-next";
import { InfoCircleOutlined, DownOutlined, EllipsisOutlined, PlusOutlined, MinusOutlined, SyncOutlined, LoadingOutlined, PaperClipOutlined, UploadOutlined, CloseCircleOutlined, UpOutlined } from "@antdv-next/icons";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Space), mergeProps({
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(btns), ({ attrs: attrs2, icon, label, tooltipTitle, dropdownProp, menu, render: render2, onClick }, index) => {
              ...
              createVNode(unref(Tooltip), { title: tooltipTitle }, {
                default: withCtx(() => [
                  menu ? (openBlock(), createBlock(unref(Dropdown), mergeProps({
                    ...
                    default: withCtx(() => [
                      createVNode(unref(Button), mergeProps({ ref_for: true }, attrs2), {
                        default: withCtx(() => [
                    ...
                    _: 2
                  }, 1040, ["disabled"])) : render2 ? (openBlock(), createBlock(resolveDynamicComponent(() => render2({ props: attrs2, ...unref(effectData) })), { key: 1 })) : (openBlock(), createBlock(unref(Button), mergeProps({
                    key: 2,
                    ref_for: true
                  }, attrs2, { onClick }), {
                    default: withCtx(() => [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(moreBtns), ({ attrs: attrs2, icon, label, tooltipTitle, onClick }) => {
                    return openBlock(), createBlock(unref(MenuItem), {
                      ...
                      default: withCtx(() => [
                        createVNode(unref(Tooltip), { title: tooltipTitle }, {
                          default: withCtx(() => [
                            createVNode(unref(Button), mergeProps({ block: "" }, { ref_for: true }, attrs2, {
                              shape: "",
                              onClick
                            }), {
                              default: withCtx(() => [
  ...
  setup(props, ctx) {
    ...
    for (let idx = 0; idx < childrenArr.length; idx++) {
      ...
      if (!independent && (!block || option.field && option.label)) {
        ...
        node = () => h(base.FormItem, reactive({ ...formItemAttrs, name: subData.propChain, rules, colon: !!label }), {
          default: innerNode,
          label
        });
      }
...
function buildInnerNode(option, model, effectData, attrs) {
  ...
  let node;
  if (type === "InfoSlot") {
    node = renderSlot2 && (() => renderSlot2({ props: attrs, ...effectData }));
  } else if (type === "Text") {
    ...
    return () => h(
      ...
      { ...formItemAttrs, rules: rules.value, ref: formItemContext, name: _propChain },
      {
        ...
        default: (slots == null ? void 0 : slots.default) || (() => h(
          compact ? base.SpaceCompact : base.Space,
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeKey = ref(__props.option.activeKey);
    const paneKeys = [];
    ...
    const panes = [...__props.model.children].map(([option, model], idx) => {
      const {
        key,
        field,
        label,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Tabs2), {
        ...
        rightExtra: withCtx(() => [!__props.isView && __props.option.buttons ? (openBlock(), createBlock(unref(_sfc_main$v), {
          key: 0,
          option: __props.option.buttons
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(panes), ({
          ...
          return openBlock(), createElementBlock(Fragment, {
            key: attrs.key
          }, [!hidden.value ? (openBlock(), createBlock(unref(TabPane2), mergeProps({
            key: 0,
            ref_for: true
          }, attrs), {
            default: withCtx(() => [__props.isView ? (openBlock(), createBlock(unref(DetailLayouts), {
              key: 0,
              option,
              modelsMap: model.children,
              effectData
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        unref(title) ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          (openBlock(), createBlock(resolveDynamicComponent(unref(toNode)(unref(title), __props.effectData))))
        ])) : createCommentVNode("", true),
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(panels), ({ attrs, hidden, option, disabled, model, header, effectData, key }) => {
              return openBlock(), createElementBlock(Fragment, { key }, [
                ...
                }, { ref_for: true }, attrs), createSlots({
                  header: withCtx(() => [
                    (openBlock(), createBlock(resolveDynamicComponent(header)))
                  ]),
                  default: withCtx(() => [
                    __props.isView ? (openBlock(), createBlock(unref(DetailLayouts), {
                      key: 0,
                      option,
                      modelsMap: model.children,
                      effectData
...
const _sfc_main$d = defineComponent({
  ...
  setup(props, { attrs: inheritAttrs, emit }) {
    ...
    const syncLabel = (value, options = optionsRef.value) => {
      ...
      const label = (item == null ? void 0 : item.label) ?? (Object.is(value, state.checkedValue) ? state.checkedChildren : Object.is(value, state.unCheckedValue) ? state.unCheckedChildren : void 0);
      emit("update:labelValue", label);
    };
    const hasOptionsSource = computed(
      () => props.options !== void 0 || props.option.options !== void 0 || Boolean(props.option.dictName)
    );
    watch(
      ...
      ([val, options]) => {
        if (val === void 0) {
          if (hasOptionsSource.value && !options.length)
            return;
          const initialValue = props.defaultChecked ? stateProps.value.checkedValue : stateProps.value.unCheckedValue;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        inputVisible.value ? (openBlock(), createBlock(unref(Input2), {
          ...
          default: withCtx(() => [
            ...
            (openBlock(), createBlock(resolveDynamicComponent(() => unref(toNode)(__props.newLabel, __props.effectData))))
          ]),
          _: 1
        }))
      ], 64);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return unref(optionsRef).length ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(optionsRef), ({ label, value }) => {
        return openBlock(), createBlock(unref(CheckableTag2), mergeProps({ ref_for: true }, _ctx.$attrs, {
          class: "tag-select",
          key: value,
...
const formItemTypes = Object.keys(formItems);
