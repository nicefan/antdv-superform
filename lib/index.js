...
import { Modal, message, ConfigProvider, Row, Col, Image, Upload } from "antdv-next";
import { g as globalConfig, b as baseComponents } from "./config-b03c8ff0.js";
...
import { r as reservedSchemaTypes } from "./schemaTypes-87eaf34d.js";
let activeAdapter;
...
function buildInnerNode(option, model, effectData, attrs) {
  ...
  const definition = (processors2 == null ? void 0 : processors2.length) ? void 0 : getFormComponent(type);
...
const _sfc_main$9 = defineComponent({
  ...
  setup(props, { attrs, slots, emit }) {
    const { Card, Tabs, TabPane } = baseComponents;
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        inputVisible.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(Input)), mergeProps({
          key: 0,
          ref_key: "inputRef",
          ref: inputRef
        }, inputProps.value, {
...
function registerComponents(definitions, components, source, additionalReservedTypes = []) {
...
function registerAutoImportedComponents(components) {
...
const install = async (app, config) => {
  ...
  if (components) {
    const adapterEnhancedTypes = Object.entries(adapter.fields || {}).filter(([, field]) => {
      var _a;
      return (_a = field == null ? void 0 : field.processors) == null ? void 0 : _a.length;
    }).map(([name]) => name);
