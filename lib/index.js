...
import { h, inject, reactive, toRefs, ref, unref, watchEffect, toValue, toRef, watch, onMounted, mergeProps, defineComponent, openBlock, createBlock, withModifiers, withCtx, createElementBlock, Fragment, renderList, createVNode, normalizeProps, guardReactiveProps, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, provide, readonly, computed, renderSlot, useAttrs, getCurrentInstance, nextTick, render as render$1, toRaw, shallowReactive, KeepAlive, createSlots, watchPostEffect, useSlots } from "vue";
import { Modal, Space, Tooltip, Button, Dropdown, Menu, MenuItem, Card, Checkbox, CheckboxGroup, Col, Collapse, CollapsePanel, DatePicker, Descriptions as Descriptions$1, DescriptionsItem, Form as Form$1, FormItem, Input, InputGroup, InputNumber, InputSearch, List, ListItem, Radio, RadioButton, RadioGroup, RangePicker, Row, Select, Switch, TabPane, Table, Tabs, Textarea, TimePicker, TreeSelect, Divider } from "ant-design-vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Space), {
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(btns), ({ attrs, icon, label, tooltip }) => {
