...
import { h, inject, reactive, toRefs, ref, unref, watchEffect, toValue, toRef, watch, onMounted, mergeProps, defineComponent, openBlock, createBlock, withModifiers, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, createVNode, normalizeProps, guardReactiveProps, provide, readonly, computed, renderSlot, useAttrs, getCurrentInstance, render as render$1, nextTick, toRaw, shallowReactive, createSlots, watchPostEffect, useSlots } from "vue";
import { Modal, Space, Button, Tooltip, Dropdown, Menu, MenuItem, Card, Checkbox, CheckboxGroup, Col, Collapse, CollapsePanel, DatePicker, Descriptions as Descriptions$1, DescriptionsItem, Form as Form$1, FormItem, Input, InputGroup, InputNumber, InputSearch, List, ListItem, Radio, RadioButton, RadioGroup, RangePicker, Row, Select, Switch, TabPane, Table, Tabs, TimePicker, TreeSelect, Divider } from "ant-design-vue";
  ...
  if (Array.isArray(actions)) {
    actions.forEach((item) => {
      ...
      if (typeof item === "object") {
        const innerMethod2 = config.onClick;
              ...
              if (text) {
                return new Promise(
                  (resolve) => Modal.confirm({
                    ...
                    cancelText: "取消",
                    onOk() {
                      innerMethod2 == null ? void 0 : innerMethod2({ ...param, meta });
                      resolve(void 0);
                    }
                  })
                );
              } else {
                return innerMethod2 == null ? void 0 : innerMethod2({ ...param, meta });
              }
            };
  ...
  watch(
    ...
    (data) => {
      ...
      if (refName) {
        ...
        if (columns || subItems) {
          (_a = model.parent)[refName] ?? (_a[refName] = columns ? [] : {});
        } else {
          (_b = model.parent)[refName] ?? (_b[refName] = initialValue);
        }
            ...
            return openBlock(), createBlock(unref(Button), mergeProps({ key: label }, attrs), {
              default: withCtx(() => [
                unref(__config).iconOnly && icon ? (openBlock(), createBlock(unref(Tooltip), {
                  ...
                  _: 2
                }, 1032, ["title"])) : (openBlock(), createElementBlock("span", _hoisted_1, [
...
function useBuildNode(option, model, effectData, attrs) {
  ...
  const node = (() => {
    switch (type) {
      ...
      case "Buttons":
        return getWrapperNode(() => h(_sfc_main$o, { config: option, param: effectData }), option.isBlock);
      default: {
    ...
    if (buttons) {
      subItems = [
        ...subItems,
        {
          ...
          align: "center",
          colProps: { flex: "auto" },
          render: () => h(_sfc_main$o, { config: buttons, param: { ...effectData, formRef } })
        }
      ];
    }
...
const Form = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__cssModules", cssModules]]);
...
function buildNodes(modelsMap, preOption, __isBlock) {
  const nodes = [];
  let currentGroup = [];
    ...
    if (model.children || model.listData) {
      ...
      if (["Table", "Tabs", "Collapse", "List"].includes(type)) {
        ...
        currentGroup.push({
          label,
          span,
          content: () => contents.map((node2) => node2())
        });
      } else {
        nodes.push(...buildNodes(modelsMap2, option, isBlock));
      }
    } else {
      currentGroup.push({
        label,
...
function getContent(option, model) {
  ...
  const effectData = getEffectData({ current: model.parent });
  const { type: colType, viewRender, render: render2, options: colOptions, labelField, keepField } = option;
  if (viewRender || colType === "InfoSlot") {
    const _render = viewRender | render2;
    return typeof _render === "string" ? rootSlots[_render] : viewRender;
  } else if (labelField) {
    ...
    return () => {
      var _a, _b;
      return (_b = (_a = options.value) == null ? void 0 : _a.find(({ value }) => value === model.refData)) == null ? void 0 : _b.label;
    };
  } else if (colType === "Switch") {
    return () => (option.valueLabels || "否是")[model.refData];
  } else if (colType === "Buttons") {
    return () => h(_sfc_main$o, { config: option, param: effectData });
  } else {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(base).Card, { title: unref(title) }, {
        extra: withCtx(() => [
          unref(buttons) ? (openBlock(), createBlock(unref(_sfc_main$o), {
            key: 0,
...
const _sfc_main$i = defineComponent({
  ...
  setup(props) {
    ...
    if (!props.isView && buttonsConfig) {
      ...
      slots[slotName] = () => [orgSlot == null ? void 0 : orgSlot(), h(_sfc_main$o, { config: buttonsConfig, param: props.effectData, methods })];
    }
    ...
    __slots.renderItem = ({ item }) => h(
      ...
      { key: item.hash },
      {
        actions: !props.isView && rowButtonsConfig && (() => h(_sfc_main$o, { config: rowButtonsConfig, methods, param: item.effectData })),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Tabs2), {
        ...
        rightExtra: withCtx(() => [!_ctx.isView && _ctx.option.buttons ? (openBlock(), createBlock(unref(_sfc_main$o), {
          key: 0,
...
function createModal(content, { buttons, ...__config } = {}) {
  ...
  const modalRef = ref();
  if (buttons) {
    __config.footer = () => h(_sfc_main$o, { config: buttons, param: { modalRef } });
  }
  const onOk = () => {
    var _a;
...
function buildDetail(option, modelsMap, rowKey) {
  const source = ref({});
  const detail = () => h(_sfc_main$k, { option: option.formSechma, modelsMap, source });
  ...
  const columns = function getConfig(_models) {
    ...
    [..._models].forEach(([col, model]) => {
      ...
      if (model.children) {
        ...
        const { type: colType, viewRender, render: render2, options: colOptions, labelField, keepField } = col;
        ...
        if (viewRender || colType === "InfoSlot") {
          ...
          textRender = ({ record, text }) => text + " - " + record[labelField];
        } else if (colOptions && typeof (colOptions == null ? void 0 : colOptions[0]) !== "string") {
          const options = ref();
          if (typeof colOptions === "function") {
          ...
          textRender = ({ text }) => {
            var _a, _b;
            return (_b = (_a = options.value) == null ? void 0 : _a.find(({ value }) => value === text)) == null ? void 0 : _b.label;
          };
        } else if (colType === "Switch") {
          textRender = ({ text }) => (col.valueLabels || "否是")[text];
        } else if (colType === "Buttons") {
          textRender = (param) => h(_sfc_main$o, { config: col, param: reactive({ ...effectData, ...param }), methods });
        } else
          ;
        let customRender;
...
function buildData({ option, listData, orgList, rowKey, listener, isView }) {
  ...
  const context = { list: orgList, columns: [], methods: {} };
  if (isView) {
  ...
  if (rowButtons) {
    ...
    const render2 = (param) => {
      return (editActionSlot == null ? void 0 : editActionSlot(param)) || h(_sfc_main$o, {
        config,
...
const _sfc_main$g = defineComponent({
  ...
  setup({ option, model, apis = {}, effectData, isView }, ctx) {
    ...
    const exposed = reactive({
      ...
      add: () => {
        var _a;
        return (_a = methods.add) == null ? void 0 : _a.call(methods);
      },
      edit: () => {
        var _a;
        return (_a = methods.edit) == null ? void 0 : _a.call(methods, editParam);
      },
      delete: () => {
        var _a;
      ...
      view: () => {
        var _a;
        return (_a = methods.view) == null ? void 0 : _a.call(methods);
      }
    });
    const tableRef = ref();
    const getTable = (el) => {
    ...
    slots.title || (slots.title = () => {
      var _a;
      return isView && ((_a = option.descriptionsProps) == null ? void 0 : _a.title) || option.label;
    });
            ...
            return openBlock(), createElementBlock(Fragment, { key }, [
              !hidden.value ? (openBlock(), createBlock(unref(CollapsePanel2), mergeProps({
                ...
                !_ctx.isView ? {
                  name: "extra",
                  fn: withCtx(() => [
                    option.buttons ? (openBlock(), createBlock(unref(_sfc_main$o), {
                      key: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(FormItem2), null, {
        default: withCtx(() => [
          ...
          }, { ...unref(valueProps), ...props.attrs, options: options.value, onChange: unref(onChange) }), null, 16, ["placeholder"])
        ]),
        _: 1
      });
    };
...
function useForm(option, data) {
  ...
  const register = (actions, _ref) => {
    if (actions) {
      ...
      return (props) => h(_sfc_main$3, { config: option, model: model.value, ...props, onRegister: register }, useSlots());
    }
  };
  ...
  return [
    register,
    {
      ...
      getSource: () => {
        const source = ref();
        getForm("dataSource").then((data2) => source.value = data2);
        return source;
      },
...
function useSearchForm(columns, searchSechma, effectData, onChange) {
  ...
  if (actions == null ? void 0 : actions.length) {
    formOption.subItems.push({
      ...
      align: "right",
      colProps: { flex: "auto" },
      render: () => h(_sfc_main$o, { config: { ...buttonsConfig, actions }, param: effectData })
    });
  }
...
const useTable = (option, data) => {
  ...
  const register = (actions, _tableRef) => {
    if (actions) {
      ...
      return (props, ctx) => h(_sfc_main$2, { dataSource: dataSource.value, ...props, onRegister: register }, ctx == null ? void 0 : ctx.slots);
    }
  };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$o), { config: _ctx.$props }, null, 8, ["config"]);
    };
  }
});
function useButtons(config) {
  const vNode = () => h(_sfc_main$o, { config });
  return [vNode];
}
...
function useDetail(option, data) {
  ...
  const register = (actions) => {
    if (actions) {
      ...
      return (props) => h(_sfc_main, { config: option, dataSource: source.value, ...props, onRegister: register }, useSlots());
    }
  };
  return [
    register,
