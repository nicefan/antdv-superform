  ...
  const columns = function getColumns(_models = childrenMap) {
    ...
    [..._models].forEach(([col, model]) => {
      ...
      if (model.children) {
        ...
        if (col.options || col.dictName || col.type === "Switch" || ((_a = col.type) == null ? void 0 : _a.includes("Picker"))) {
          column.align = "center";
...
function parseRender(viewRender, editRender, effectData) {
  if (editRender || viewRender) {
    const __render = (param) => {
      const result = (editRender == null ? void 0 : editRender(param)) ?? (viewRender == null ? void 0 : viewRender(param)) ?? String(param.text ?? "");
