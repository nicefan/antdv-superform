  ...
  setup(props, ctx) {
    ...
    const unWatch = watch(
      ...
      (opt) => {
        ...
        dataRef.value ?? (dataRef.value = dataSource || []);
        ...
        const tabsField = (_a2 = opt.tabsFilter) == null ? void 0 : _a2.field;
        if (tabsField) {
          const tabsKey = (_a = opt.tabsFilter).activeKey ?? (_a.activeKey = ref(opt.tabsFilter.defaultActiveKey));
          watch(
            tabsKey,
            (key) => {
