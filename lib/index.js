import "./style.css";
import { get, set, merge as merge$1, update, cloneDeep, isPlainObject, defaults, uniq, isFunction, mergeWith, isArray, isString, isObject, throttle, omit, debounce, mapKeys, camelCase } from "lodash-es";
    ...
    if (labelField) {
      ...
      return (param = effectData, inner) => {
        ...
        const values = arr.map((val) => {
          var _a;
          const item = (_a = unref(optionsArr)) == null ? void 0 : _a.find(({ value }) => value == val);
          if (!inner && autoTag) {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Space), mergeProps({
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(btns), ({ attrs: attrs2, icon, label, tooltip, dropdownProp, menu, render: render2, onClick }, index) => {
            return openBlock(), createElementBlock(Fragment, { key: label }, [
              menu ? (openBlock(), createBlock(unref(Dropdown), mergeProps({
                ...
                _: 2
              }, 1040, ["disabled"])) : tooltip || iconOnly && icon ? (openBlock(), createBlock(unref(Tooltip), {
                key: 1,
                title: tooltip || label
              }, {
                default: withCtx(() => [
                  render2 ? (openBlock(), createBlock(resolveDynamicComponent(() => render2({ props: attrs2, ...unref(effectData) })), { key: 0 })) : (openBlock(), createBlock(unref(Button), mergeProps({ key: 1 }, attrs2, { onClick }), {
                    default: withCtx(() => [
          ...
          unref(moreBtns).length ? (openBlock(), createBlock(unref(Dropdown), { key: 0 }, {
            overlay: withCtx(() => [
              createVNode(unref(Menu), null, {
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(moreBtns), ({ attrs: attrs2, icon, label, onClick }) => {
                    return openBlock(), createBlock(unref(MenuItem), {
                      key: label,
                      disabled: attrs2.disabled
                    }, {
  ...
  [...modelsMap].forEach(([option, model], idx) => {
    ...
    if (type === "InputGroup") {
      if (!viewRender) {
        ...
        render$12 = () => h(Space, { direction: isBreak ? "vertical" : "horizontal" }, () => contents.map((node) => node()));
      }
    ...
    if (nodeItems.length && !isBlock) {
      ...
      if (nodeItems.length && label) {
        ...
        render$12 = ((_b = nodeItems[0]) == null ? void 0 : _b.content) || render$12;
    ...
    edit(args) {
      ...
      if ((_a = option.apis) == null ? void 0 : _a.info) {
        option.apis.info(rowKey(data), data).then((res) => {
          var _a2;
          (_a2 = formRef.value) == null ? void 0 : _a2.setFieldsValue(merge(res, resetData));
        });
      }
  ...
  setup({ option, model, apis = {}, effectData, isView, ...props }, ctx) {
    ...
    const listener = {
      ...
      async onDelete(items) {
        ...
        try {
          await ((_a2 = apis.delete) == null ? void 0 : _a2.call(apis, keys, items));
        } catch (error) {
          console.error(error);
          return error;
        }
        ...
        return (_b2 = apis.query) == null ? void 0 : _b2.call(apis, true);
      }
    };
...
function useQuery(option, updateSource) {
  ...
  const request = (param) => {
    ...
    if (!((_b = option.apis) == null ? void 0 : _b.query))
      return;
    loading.value = true;
    return Promise.resolve(
...
const _sfc_main$2 = defineComponent({
  ...
  setup(props, ctx) {
    ...
    const { loading, pagination, setPageData, onLoaded, goPage, reload, query, setQueryParams, getQueryParams } = useQuery(option, updateSource);
