...
import { DownOutlined, EllipsisOutlined, PlusOutlined, MinusOutlined, SyncOutlined, LoadingOutlined, PaperClipOutlined, UploadOutlined, CloseCircleOutlined, UpOutlined } from "@ant-design/icons-vue";
...
function useTableEdit({
  ...
  const InputNode2 = /* @__PURE__ */ defineComponent({
    ...
    setup({
      ...
      const rules = computed(() => unref(attrs.disabled) ? void 0 : model2.value.rules);
