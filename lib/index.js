...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const actions = !slotsNode ? props.actions : slotsNode.flatMap(({ children, props: props2 }) => {
      const { roleName, roleMode, onClick, confirmText, icon, ...attrs } = props2 || {};
      if (!onClick || !children)
        return [];
      return {
