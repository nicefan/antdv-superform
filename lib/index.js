  ...
  setup(props, ctx) {
    ...
    [...props.model.children].forEach(([option, subData], idx) => {
      ...
      if (type === "Hidden" || hideInForm || (exclude == null ? void 0 : exclude.includes("form"))) {
        const valueProps = useVModel({ option, model: subData, effectData });
        nodes.push(() => h("input", { ...valueProps, type: "hidden" }));
        return;
      }
