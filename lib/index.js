    ...
    if (props.bordered) {
      return () => h(
        ...
        },
        {
          ...
          extra: tabBarExtraSlot ? extra : void 0,
          ...innerSlots
        }
      );
    } else {
...
const _sfc_main$j = defineComponent({
  ...
  setup({ option, model, apis = {}, effectData, isView }, ctx) {
    ...
    const titleBar = (titleSlot || extraSlot) && (() => h(Row, { align: "middle", style: "width:100%" }, () => [
    ...
    return () => option.columns && h(
      ...
      () => searchForm.value ? h(
        ...
        [
          ...
          h("div", { class: "sup-form-section section-last" }, h(Controls.Table, tableAttrs, slots))
        ]
      ) : h(
        "div",
        mergeProps(
